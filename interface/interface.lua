    ...
    -- Library element functions
        ...
        function library:init_config(window) 
            ...
            section:button({
                name = "Save",
                callback = function()
                    writefile(library.directory.."/configs/lover.cfg", library:get_config())
            ...
            section:button({
                name = "Load",
                callback = function()
                    library:load_config(readfile(library.directory.."/configs/lover.cfg"))
                    library:update_config_list()
                    library:create_notification({
                        name = "Configs",
            ...
            section:button({name = "Delete", callback = function() delfile(library.directory.."/configs/lover.cfg")  library:update_config_list() library:create_notification({name = "Configs", info = "Deleted config:\n" .. flags["config_name_list"]}) end})
